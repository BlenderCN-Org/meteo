...
##def opencv_draw_line(img, X, Y):
    ### Origine en haut à gauche
    ### Draw a white line, from A to B, thickness of 2 px
    ##cv2.line(img, (X[0], X[1]), (Y[0], Y[1]), (255, 255, 255), 2)
