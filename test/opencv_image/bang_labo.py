...
def superposition(background, foreground, decal):
    ...
    # Now black-out the area of blackground in roi
    ...
    # Put fg on bg
    ##dst = cv2.addWeighted(bg, 0.5, fg, 0.5, 0)
    dst = cv2.add(bg, fg)
    background[b:h, a:l] = dst
