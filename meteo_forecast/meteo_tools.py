...
class MeteoTools:
    ...
    def get_all_files(self, master_dir):
        ...
        clé = répertoires
        valeur = liste de tous les fichiers, trié par date croissante
        dict = {    "2017_06": [meteo_x0.html, meteo_x1.html .....],
                    "2017_07": [meteo_y0.html, meteo_y1.html .....],}
        """
        ...
        for directory in os.listdir(master_dir):
            ...
            for fichier in os.listdir(master_dir + "/" + directory):
                if fichier.endswith(".html"):
                    ...
                    all_files[directory].append(file_name)
    ...
    def get_date_hour_mn_key_from_datetime(self, day_time):
        """Retourne le str 2017_06_11_16_05 avec 2017-06-11 16:05:30 de type datetime."""
    ...
    def get_year_month_day(self, key):
        """Retourne année jour soit 2017_06 dans 2017_06_22_15_05_48."""
